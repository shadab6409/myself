...
if( ! function_exists( 'avo_portfolio_func' ) )
{
	function avo_portfolio_func( $attr, $content = null )
	{
		extract(shortcode_atts(array(
			...
			'bg_content'						=> '',
			'content_align'						=> 'left',
			'img_filter_normal'					=> 'grayscale(100%)',
			'img_filter_hover'					=> 'grayscale(100%)',
			'title_type'						=> 'block',
			'title_cl'							=> '',
			'title_clh'							=> '',
			'title_bgl'							=> '',
		...
		ob_start();
		include( plugin_dir_path( __FILE__ ) . 'portfolio__view.php' );
		return ob_get_clean();
	}
}

add_shortcode( 'avo_portfolio', 'avo_portfolio_func' );

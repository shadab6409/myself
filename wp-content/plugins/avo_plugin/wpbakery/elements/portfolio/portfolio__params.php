...
vc_map( array (
    ...
    'description' 	=> __('Create custom portfolio element', 'avo_plg'),
    'params' 		=> array (
        // General
        ...
        array (
            ...
            'description'   => __('Please use numbers only.', 'avo_plg'),
            'admin_label'   => false,
            'group' => __( 'General', 'avo_plg' ),
            'value' => __( '8', 'avo_plg' ),
        ),
        array(
            'type' => 'dropdown',
            'group' => __( 'General', 'avo_plg' ),
            'heading' => __('Portfolio masonry', 'avo_plg'),
            'param_name' => 'port_masonry',
            'value' => array(
                __( 'Yes', 'avo_plg' ) => 'yes',
                __( 'No', 'avo_plg' ) => 'no', 
            ),
        ...
        array(
            'type' => 'dropdown',
            'group' => __( 'General', 'avo_plg' ),
            'heading' => __('Sort Portfolio by Portfolio Category', 'avo_plg'),
            'param_name' => 'sort_cat',
            'value' => array(
                __( 'Yes', 'avo_plg' ) => 'yes',
                __( 'No', 'avo_plg' ) => 'no', 
        ...
        array(
            ...
            'value' => array(
                __( 'Two Columns', 'avo_plg' ) => '2',
                __( 'Three Columns', 'avo_plg' ) => '3', 
                __( 'Four Columns', 'avo_plg' ) => '4', 
            ),
        ),
        array(
            'type' => 'dropdown',
        ...
        array (
            'param_name'    => 'nav_prev',
            'type'          => 'textfield',
            'heading'       => __('Previous', 'avo_plg'),
            'group' => __( 'General', 'avo_plg' ),
            'value' => __( 'Prev', 'avo_plg' ),
            'dependency' => array(
                'element' => 'port_style',
                'value' => array(
                    'style-4',
        ...
        array(
            'type' => 'textfield',
            'group' => __( 'Portfolio Item Settings', 'avo_plg' ),
            'heading' => __( 'Margin', 'avo_plg' ),
            'param_name' => 'portfolio_margin',
            'description' => __( 'Please add value start from 0 to 100 with the unit (for example: px or %).', 'avo_plg' ),
        ), 
        array(
            'type' => 'textfield',
            'group' => __( 'Portfolio Item Settings', 'avo_plg' ),
        ...
        array(
            'type' => 'dropdown',
            'group' => __( 'Image Settings', 'avo_plg' ),
            'heading' => __('Image filter (normal)', 'avo_plg'),
            'param_name' => 'img_filter_normal',
            'value' => array(
                __( 'Gray', 'avo_plg' ) => 'grayscale(100%)',
                __( 'Colored', 'avo_plg' ) => 'initial',
            ),
        ),
        array(
            'type' => 'dropdown',
            'group' => __( 'Image Settings', 'avo_plg' ),
            'heading' => __('Image filter (hover)', 'avo_plg'),
            'param_name' => 'img_filter_hover',
            'value' => array(
                __( 'Gray', 'avo_plg' ) => 'grayscale(100%)',
                __( 'Colored', 'avo_plg' ) => 'initial',
            ),
        ...
        array(
            'type' => 'colorpicker',
            'group' => __( 'Title Content Settings', 'avo_plg' ),
            'heading' => __('Title Color (Hover)', 'avo_plg'),
            'param_name' => 'title_clh',
        ),
        array(
            'type' => 'colorpicker',
            'group' => __( 'Title Content Settings', 'avo_plg' ),
        ...
        array(
            'type' => 'colorpicker',
            'group' => __( 'Portfolio Mask Settings', 'avo_plg' ),
        ...
        array(
            'type' => 'colorpicker',
            'group' => __( 'Portfolio Mask Settings', 'avo_plg' ),
            'heading' => __('Mask Color Second ', 'avo_plg'),
        ...
        array(
            ...
            'description' => __( 'Plaese set mask posisition from -200 to 200', 'avo_plg' ),
        ), 
        array(
            'type' => 'textfield',
            'group' => __( 'Portfolio Mask Settings', 'avo_plg' ),
            ...
            'description' => __( 'Plaese set color opacity from 0.1 to 1', 'avo_plg' ),
        ), 
        array(
            'type' => 'colorpicker',

  ...
  ?>
	<div class="hidden share-remove">
      <div class="share-box">
         ...
         title="<?php esc_html_e("Share on Facebook", "avo_plg"); ?>">
...
function avo_share_box_single() {
	if (is_singular( 'post' )) {
		add_action( 'wp_footer', 'avo_sharebox',1 );
	}
} 
add_action( 'wp_enqueue_scripts', 'avo_share_box_single' );		
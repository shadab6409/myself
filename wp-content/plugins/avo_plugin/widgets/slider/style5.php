        <section class="slide-full <?php echo "slider-style-5"; ?>" <?php echo 'data-slider-settings=\'{"autoplay":'.$autoplay.',"parallax":'.$parallax.',"loop":'.$loop.',"speed":'.$speed.'}\''; ?>>
            <div class="swiper-container parallax-slider">
                <div class="swiper-wrapper">
                	<?php foreach ( $settings['slider_list'] as $index => $item ) : ?> 
                    <div class="swiper-slide">
                        <div class="bg-img <?php if ($item['image_animation']){echo "img-anim";}?>" style="background-image:url(<?php echo esc_url ( $item['image']['url']); ?>);" data-overlay-dark="4">

        ...
        <div class="slider home-slider  ani-slider  clearfix <?php echo "slider-style-3"; ?>" data-slick='{"autoplaySpeed": <?php echo esc_attr ( $settings['slider_speed'] )?>,"fade" : <?php echo esc_attr ( $settings['animation_type'] )?>,"Speed": <?php echo esc_attr ( $settings['animation_speed'] )?>}'>

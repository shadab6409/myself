<div class="better-slider style-10 better-valign better-bg-img" data-background="<?php echo esc_url ( $settings['bg_image']['url']); ?>" data-overlay-dark="<?php echo $settings['slider_mask'];?>">
    <div class="container">
        <div class="row">
                ...
                <div class="caption hmone">
                    ...
                    <?php if ( ! empty( $settings['slider5_btn_link']['url'] ) ) : ?>
                        <a href="<?php echo esc_url ( $settings['slider5_btn_link']['url'] ) ; ?>" class="better-btn-architec btn-bord btn-lit mt-30">
                            <span><?php echo esc_attr ( $settings['slider5_btn_text'] ) ; ?></span>
                        </a>
                    <?php endif; ?>
                </div>
            </div>

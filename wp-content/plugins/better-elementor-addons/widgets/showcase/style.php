    ...
    <div class="swiper-container parallax-slider">
                                    ...
                                    <div class="caption">
                                        <h1>
                                            <a href="<?php echo esc_url($item['link']['url']); ?>">
                                                <div class="stroke" data-swiper-parallax="-2000"><?php echo  $item['title']; ?></div> <span data-swiper-parallax="-5000"><?php echo  $item['subtitle']; ?></span>
                                            </a>
                                            <div class="bord"></div>
                                        </h1>
                                        <div class="discover">
        ...
        <div class="txt-botm">
            <div class="swiper-button-next swiper-nav-ctrl next-ctrl cursor-pointer">
                <div>
                    <span><?php echo esc_attr( $settings['nav_next']); ?></span>
                </div>
            ...
            <div class="swiper-button-prev swiper-nav-ctrl prev-ctrl cursor-pointer">
                ...
                <div>
                    <span><?php echo esc_attr( $settings['nav_prev']); ?></span>
                </div>
            </div>
        </div>
        <?php endif; ?>

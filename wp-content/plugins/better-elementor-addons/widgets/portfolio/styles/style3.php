            ...
            <?php foreach ( $settings['portfolio_items'] as $index => $item ) : ?>
                <div class="swiper-slide">
                    <div class="better-bg-img better-valign" data-background="<?php echo esc_url ( $item['item_image']['url']); ?>" data-overlay-dark="5">
                        <div class="caption">
                            <a href="<?php echo esc_url( $item['item_cat_link']['url']); ?>"><span class="tag"><?php echo  $item['item_cat']; ?></span></a>
                            <h1 data-splitting><a href="<?php echo esc_url( $item['item_link']['url']); ?>"><?php echo  $item['item_title']; ?></a>
                            </h1>
                        </div>
                    </div>
                </div>

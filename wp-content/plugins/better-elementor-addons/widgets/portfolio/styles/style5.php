            ...
            <?php foreach ( $settings['portfolio_items'] as $index => $item ) : ?>
                <div class="swiper-slide">
                    <div class="item">
                        ...
                        <div class="cont">
                            <h6><?php echo  $item['item_title']; ?></h6>
                            <span><a href="<?php echo esc_url( $item['item_cat_link']['url']); ?>"><?php echo  $item['item_cat']; ?></a>, <a href="<?php echo esc_url( $item['item_cat_link_2']['url']); ?>"><?php echo  $item['item_cat_2']; ?></a></span>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>

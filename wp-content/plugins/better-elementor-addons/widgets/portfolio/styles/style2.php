        ...
        <div class="col-lg-12 no-padding">
            <div class="swiper-container">
                    ...
                    foreach ( $settings['portfolio_items'] as $index => $item ) : 
                        ...
                        <div class="swiper-slide">
                            <div class="content wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="cont">
                                    <h6><a href="<?php echo esc_url( $item['item_cat_link']['url']); ?>"><?php echo  $item['item_cat']; ?></a></h6>
                                    <h4><a href="<?php echo esc_url( $item['item_link']['url']); ?>"><?php echo  $item['item_title']; ?></a></h4> 
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                ...
                <div class="set-control">
                    ...
                    <div class="totalslide custom-font"><?php echo $count ?></div>
                </div>
            </div>
        </div>
    </div>

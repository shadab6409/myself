            ...
            <?php foreach ( $settings['portfolio_items'] as $index => $item ) : ?>
                <div class="swiper-slide">
                    <div class="item">
                        ...
                        <div class="cont">
                            <h5><a href="<?php echo esc_url( $item['item_link']['url']); ?>"><?php echo  $item['item_title']; ?></a></h5>
                            <span><a href="<?php echo esc_url( $item['item_cat_link']['url']); ?>"><?php echo  $item['item_cat']; ?></a></span><span><a href="<?php echo esc_url( $item['item_cat_link_2']['url']); ?>"><?php echo  $item['item_cat_2']; ?></a></span>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>

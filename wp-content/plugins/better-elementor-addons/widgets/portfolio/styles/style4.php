        ...
        <div class="row">
            ...
            <div class="gallery better-full-width">
                ...
                <?php foreach ( $settings['portfolio4_items'] as $index => $item ) : ?>
                    <div class="col-md-<?php echo $settings['better_portfolio4_columns'] ?> items <?php echo  $item['portfolio4_item_category_slug_call']; ?>">
                        <div class="item-img wow fadeInUp" data-wow-delay=".4s">
                            <a href="<?php echo esc_url( $item['portfolio4_item_link']['url']); ?>">
                                <img src="<?php echo esc_url ( $item['portfolio4_item_image']['url']); ?>" alt="image">
                                <div class="item-img-overlay better-valign">
                                    <div class="overlay-info better-full-width">
                                        <h5 data-splitting><?php echo  $item['portfolio4_item_title']; ?></h5>
                                        <p class="wow txt" data-splitting><?php echo  $item['portfolio4_item_cat']; ?></p>
                                    </div>
                                </div>
                            </a>
                        </div>

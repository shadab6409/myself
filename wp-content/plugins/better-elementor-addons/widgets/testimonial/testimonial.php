...
class Better_Testimonial extends Widget_Base {
	...
	protected function render() {
		...
		$better_testimonial_description = $settings['better_testimonial_description'];
		$better_testimonial_author_image = $settings['better_testimonial_author_image']['url'];
		$better_testimonial_author_name = $settings['better_testimonial_author_name'];
		$better_testimonial_author_designation = $settings['better_testimonial_author_designation'];
       ?>
			<div class="better single-testimonial">
				<i class="fas fa-quote-left"></i>
				<p><?php echo $better_testimonial_description;?></p>
				<div class="authro-info">
					<h4><img src="<?php echo $better_testimonial_author_image;?>" alt=""><?php echo $better_testimonial_author_name;?> <span><?php echo $better_testimonial_author_designation;?></span></h4>
				</div>
			</div>
       <?php
	}

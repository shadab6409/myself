                ...
                <div class="map-info">
                    ...
                    <div class="con-info mt-30">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="item">
                                    <h4><?php echo $settings['contact_location_title'] ?></h4>
                                    <li>
                                        <span class="icon pe-7s-map-marker"></span>
                                        <div>
                                            <p><?php echo $settings['contact_location_info'] ?></p>
                                        </div>
                                    </li>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="item">
                                    <h4><?php echo $settings['contact_contactus_title'] ?></h4>
                                    <li>
                                        <span class="icon pe-7s-call"></span>
                                        <p><?php echo $settings['contact_contactus_phone'] ?></p>
                                    </li>
                                    <li>
                                        <span class="icon pe-7s-mail"></span>
                                        <p><a href="#0"><?php echo $settings['contact_contactus_mail'] ?></a></p>
                                    </li>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="opening better-bg-img better-bg-repeat" data-background="<?php echo esc_url( plugins_url('/assets/img/dotz.png', dirname(__FILE__,3)) ) ?>">
                    <div class="toup">
                        ...
                        <div class="mt-80">
                            <a href="<?php echo $settings['btn_contact_link']['url'] ?>" class="better-btn-skew btn-color btn-bg">
                                <span><?php echo $settings['btn_contact_title'] ?></span>
                                <i></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-9 col-md-11">
                <div class="contact-form">
                    ...
                    <div class="better-heading style-6 text-center">
                        <h6><?php echo $settings['title_style5_1'] ?></h6>
                        <h3><?php echo $settings['title_style5_1'] ?></h3>
                        <span class="icon">
                        <i>

                ...
                <div class="cont">
                    ...
                    <div class="tags">
                        <?php if(!empty($item['tag_text_1'])) : ?>
                            <a href="<?php echo esc_url ( $item['tag_link_1']['url']); ?>"><?php echo  $item['tag_text_1']; ?></a>
                        <?php endif; ?>
                        <?php if(!empty($item['tag_text_2'])) : ?>
                            <a href="<?php echo esc_url ( $item['tag_link_2']['url']); ?>"><?php echo  $item['tag_text_2']; ?></a>
                        <?php endif; ?>
                        <?php if(!empty($item['tag_text_3'])) : ?>
                            <a href="<?php echo esc_url ( $item['tag_link_3']['url']); ?>"><?php echo  $item['tag_text_3']; ?></a>
                        <?php endif; ?>    
                    </div>

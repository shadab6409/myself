    ...
    <div class="item cir md-mb50">
        <div class="img">
            ...
            <div id="circle">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g>
                        ...
                        <text fill="#c5a47e">
                            <textPath xlink:href="#circlePath"><?php echo $settings['better_team_desg']; ?> <?php echo $settings['better_team_desg']; ?> <?php echo $settings['better_team_desg']; ?>
                            </textPath>
                        </text>
                    </g>
                </svg>
            ...
            <div class="info">
                ...
                <span><?php echo $settings['better_team_desg']; ?></span>
            </div>
        </div>
    </div>
</div>
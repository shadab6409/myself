...
class BEA_Admin_Ajax {
    ...
    public function bea_check_nonce() {
        ...
        if (!wp_verify_nonce($nonce, $action)) {
            // build response
            $response = $this->ajax_response(false, __('Sorry, an error occurred. Please refresh the page.', 'better-el-addons'));
    ...
    public function bea_admin_ajax() {
        ...
        switch ($func) {
            ...
            case 'bea_reset_settings':
                ...
                break;
            default:
                $response = ajax_response(false, __('Sorry, an unknown error occurred...', 'better-el-addons'), null);
                break;
        }

...
if ( function_exists( 'bea_fs' ) ) {
    bea_fs()->set_basename( false, __FILE__ );
} else {
    
    if ( !function_exists( 'bea_fs' ) ) {
        // Plugin version
        define( 'BEA_VERSION', '1.3.0' );
        // Plugin Root File
        ...
        function bea_fs()
        {
            ...
            if ( !isset( $bea_fs ) ) {
                ...
                $bea_fs = fs_dynamic_init( array(
                    'id'             => '9800',
                    'slug'           => 'better-elementor-addons',
                    'premium_slug'   => 'better-elementor-addons-pro',
                    'type'           => 'plugin',
                    'public_key'     => 'pk_fda186a73ced87b6207a102c6ce4d',
                    'is_premium'     => false,
                    'premium_suffix' => '(Pro)',
                    'has_addons'     => false,
                    'has_paid_plans' => true,
                    'menu'           => array(
                    'slug'       => 'better_el_addons',
                    'first-path' => 'admin.php?page=better_el_addons',
                    'support'    => false,
                ),
                    'is_live'        => true,
                ) );
